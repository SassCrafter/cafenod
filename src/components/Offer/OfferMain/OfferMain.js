				...
				<Flex.Column className={classes.TextContainer}>
					<Text>
						...
						<Text.Paragraph>
							...
							serve as centers of social interaction: the
							coffeehouse provides patrons with a place to
							congregate, talk, read, write, entertain one
							another, or pass the time, whether individually or
							in small groups.
						</Text.Paragraph>
						<Text.Paragraph>
							From a cultural standpoint, coffeehouses largely
